...
DEFAULT_GRAPH_EVALUATION_CASES = (
    ...
    GraphEvaluationCase(
        ...
        kind="relationship",
        query="How is the Graphiti FalkorDB runtime isolated from Milvus using dedicated Colima profile graphiti-mon316 on MacBook Pro 16?",
        graph_must_contain=(
            "MacBook Pro 16",
    ...
    GraphEvaluationCase(
        name="relationship-batch019-macbook-runtime-isolation",
        kind="relationship",
        query="MacBook Pro 16 Graphiti main drive Colima profile Milvus isolation runtime state",
        graph_must_contain=(
            "MacBook Pro 16",
            "/Users/dominicmonkhouse/.colima/graphiti-mon316",
            "graphiti-mon316",
    ...
    GraphEvaluationCase(
        name="relationship-batch019-macbook-mcp-routing",
        kind="relationship",
