...
def run_due_tasks(
    *,
    ...
    default_memsearch_dir = os.environ.get("MEMSEARCH_DIR", project_root / ".memsearch") if project_dir is None else project_root / ".memsearch"
    mem_root = Path(memsearch_dir or default_memsearch_dir).expanduser()
